...
@MainActor
protocol DeviceMigrationServiceProtocol {
...
final class DeviceMigrationService: DeviceMigrationServiceProtocol {
    ...
    private let tag = "DeviceMigrationService"
    ...
    private func determineBodyCompSupport(for ionicScale: IonicScaleData) -> Bool {
        ...
        if let sku = ionicScale.sku {
            return DeviceInfoUtils.shared.supportsBodyComposition(sku: sku)
        }
        return false
    }
