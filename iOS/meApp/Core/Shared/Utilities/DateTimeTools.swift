// DateTimeTools.swift
// Utility class for date and time formatting, parsing, and timezone operations.
// Provides static methods for common date/time manipulations used throughout the app.
//
// All methods are thread-safe and stateless. Uses ISO8601 and custom formats as needed.
