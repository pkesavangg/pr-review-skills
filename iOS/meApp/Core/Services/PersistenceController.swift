...
final class PersistenceController {
    ...
    private init() {
        let schema = Schema([Account.self, Device.self, BathScale.self, Entry.self, R4ScalePreference.self, BathScaleMetric.self, DeviceMetaData.self, BathScaleEntry.self, LogEntry.self, WeightCompSettings.self, GoalSettings.self, IntegrationSettings.self, NotificationSettings.self, StreaksSettings.self, WeightlessSettings.self, DashboardSettings.self])
