...
/// Handles all month-specific chart rendering including scrolling and day-based interactions
struct MonthGraphView: View {
    ...
    private func chartContentForSegment(segment: [GraphSeries], seriesName: String, segmentIndex: Int) -> some ChartContent {
        ForEach(segment) { point in
            ...
            .symbolSize(point.date == viewModel.selectedPoint?.date ? 200 : viewModel.getPointSizeForMonth())
