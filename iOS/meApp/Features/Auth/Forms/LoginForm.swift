...
class LoginForm: ObservableForm {
    var email = FormControl("pkesavan@greatergoods.com", validators: [.required, .email, .maxLength(100)])
    var password = FormControl("123456", validators: [.required, .minLength(6), .maxLength(50)])
