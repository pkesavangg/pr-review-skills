...
class SignupForm: ObservableForm {
    var firstName = FormControl("Kesavan", validators: [.required, .noWhiteSpace, .maxLength(100)])
    var lastName = FormControl("Panchabakesan", validators: [.required, .noWhiteSpace, .maxLength(100)])
