...
#Preview {
    ScaleSetupFinishView(title: "Your scale is paired and ready to go!", description: "To sync new entries, tap the icon at the bottom right of the app when you see the result code display on your scale’s screen.")
