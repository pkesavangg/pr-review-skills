...
public struct WifiScaleSetupStrings {
    ...
    struct WifiPasswordViewStrings {
        ...
        static let description = "Make sure your phone is connected to a 2.4 GHz Wi-Fi Network. The network name you enter should match the one your phone is currently connected to."
    ...
    struct ErrorDetailViewStrings {
        ...
        static let other = "Exit the setup and try again from the start. If this doesn't work out for you, give us a call and we'll work through it together."
