...
fun SettingsScreenContent(
  ...
  AppScaffold(title = SettingsScreenStrings.Title) {
    Column(
      ...
      AccountSettingsSection(state = state, handleIntent = handleIntent)
      AppSettingsSection(state = state, handleIntent = handleIntent)
      ...
      if (state.isMyWeightEnabled) {
        WeightScaleSection(state = state, handleIntent = handleIntent, viewModel = viewModel)
      }
      SupportSection(handleIntent = handleIntent)
      // Developer/Testing Section (only show when testing features are enabled)
      if (state.enableTestingFeatures) {
        DeveloperOptionsSection(state = state, handleIntent = handleIntent)
      }
      AccountActionsSection(state = state, handleIntent = handleIntent)
    }
  }
}
...
private fun AccountSettingsSection(
  ...
  val navigate: (AppRoute) -> Unit = { route ->
    coroutineScope.launch { backStack.addRoute(route) }
  }
  SettingsSection(
    ...
    items = buildList {
      add(
        SettingsItem(
          ...
          onClick = { navigate(AppRoute.AccountSettings.Profile) },
        ),
      )
      ...
      add(
        SettingsItem(
          ...
          onClick = { navigate(AppRoute.AccountSettings.MyKids) },
        ),
      )
      add(
        SettingsItem(
          ...
          onClick = { handleIntent.invoke(SettingsIntent.OpenMyDevices) },
        ),
      )
      ...
      if (state.showIntegrations) {
        add(
          SettingsItem(
            ...
            onClick = { navigate(AppRoute.Integration.IntegrationList) },
          ),
        )
      }
      add(
        SettingsItem(
          ...
          onClick = { navigate(AppRoute.AccountSettings.ChangePassword) },
        ),
      )
    },
  )
        ...
        if (state.showUnitType) {
          add(
            SettingsItem(
              ...
              onClick = { handleIntent.invoke(SettingsIntent.ShowUnitTypeModal) },
            ),
          )
        }
        add(
          SettingsItem(
            ...
            onClick = { navigate(AppRoute.AccountSettings.AppPermissions) },
          ),
        )
        add(
          SettingsItem(
            ...
            onClick = { navigate(AppRoute.Feed.FeedMessages) },
          ),
        )
        add(
          SettingsItem(
            ...
            onClick = { handleIntent.invoke(SettingsIntent.ShowAppearanceModal) },
          ),
        )
      },
  )
...
// My Weight Section
@Composable
private fun WeightScaleSection(
  state: SettingsState,
  handleIntent: (SettingsIntent) -> Unit,
    ...
    items =
      listOf(
        SettingsItem(
          ...
          onClick = { handleIntent.invoke(SettingsIntent.ShowNotificationsModal) },
        ),
        SettingsItem(
          title = SettingsScreenStrings.GoalSetting,
          type = SettingsItemType.Action(),
          testTag = TestTags.Settings.GoalSetting,
          onClick = { handleIntent.invoke(SettingsIntent.goalSettingModal) },
        ),
        SettingsItem(
          ...
          onClick = { handleIntent.invoke(SettingsIntent.ShowActivityLevelModal) },
        ),
        SettingsItem(
          ...
          onClick = { handleIntent.invoke(SettingsIntent.NavigateToWeightless) },
        ),
      ),
  )
}
    ...
    items = buildList {
      add(
        SettingsItem(
          ...
          onClick = { handleIntent(SettingsIntent.ShowMacAddressFilterModal) },
        ),
      )
      if (BuildConfig.DEBUG) {
        add(
          SettingsItem(
            ...
            type = SettingsItemType.Action(),
            onClick = { handleIntent(SettingsIntent.OpenA3MonitorSetup) },
          ),
        )
        add(
          SettingsItem(
            ...
            onClick = { handleIntent(SettingsIntent.TriggerTestCrash) },
          ),
        )
        add(
          SettingsItem(
            ...
            type = SettingsItemType.None,
            onClick = { handleIntent(SettingsIntent.TriggerTestNonFatal) },
          ),
        )
      }
    },
    ...
    items = buildList {
      add(
        SettingsItem(
          ...
          onClick = { handleIntent(SettingsIntent.SwitchAccount) },
        ),
      )
      add(
        SettingsItem(
          ...
          onClick = { handleIntent(SettingsIntent.Logout) },
        ),
      )
      if (state.hasMultipleAccounts) {
        add(
          SettingsItem(
            ...
            onClick = { handleIntent(SettingsIntent.LogoutAllAccounts) },
          ),
        )
      }
      add(
