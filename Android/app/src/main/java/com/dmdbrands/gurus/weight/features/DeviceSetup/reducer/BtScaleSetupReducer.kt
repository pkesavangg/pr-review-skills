...
data class BtScaleSetupState(
  override val scaleSetupState: DeviceSetupState<BtScaleSetupStep> = DeviceSetupState(
  ...
  override fun copyBaseState(scaleSetupState: DeviceSetupState<BtScaleSetupStep>): BtScaleSetupState {
 ...
 */
sealed interface BtScaleSetupIntent : DeviceSetupIntent {
 ...
 */
class BtScaleSetupReducer : DeviceSetupReducer<BtScaleSetupStep, BtScaleSetupState>() {
  override fun reduce(
