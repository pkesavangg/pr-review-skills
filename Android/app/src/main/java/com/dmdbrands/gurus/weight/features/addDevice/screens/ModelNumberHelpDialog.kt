...
import com.dmdbrands.gurus.weight.features.addDevice.strings.AddDeviceHelpStrings
...
fun ModelNumberHelpDialog(
    ...
    modifier: Modifier = Modifier,
        ...
        AppPopupModal {
          AppPopup(
            visible = visible,
            supportingText = AddDeviceHelpStrings.SupportingText,
            onClose = onClose,
            imageType = AppPopupImageType.CustomImage(
              image = {
                Image(
                  painter = painterResource(AppIcons.Default.ModalNumber),
                  contentDescription = AddDeviceHelpStrings.ImageContentDescription,
                  modifier =
                    Modifier
                      .fillMaxWidth()
                      .height(120.dp),
