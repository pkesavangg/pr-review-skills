 ...
 */
enum class MonitorSetupStep : DeviceSetupStep {
  MONITOR_DETAIL,
  PERMISSIONS,
  USER_SELECTION,
...
object MonitorSetupStepHelper {
  ...
  fun setupTypeForSku(sku: String): DeviceSetupType =
    if (isA6Sku(sku)) DeviceSetupType.BpmA6Bluetooth
    else DeviceSetupType.BpmBluetooth
