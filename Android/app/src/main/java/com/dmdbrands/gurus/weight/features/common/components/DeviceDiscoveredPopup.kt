...
fun DeviceDiscoveredModal(
  ...
  Box(
    ...
    Column(
      ...
      AppText(
        text = AppPopupStrings.DeviceDiscoveredPopup.Title(sku),
      ...
      AppButton(
        label = AppPopupStrings.DeviceDiscoveredPopup.ConnectButton,
...
@PreviewTheme
@Composable
fun DeviceDiscoveredModalPreview() {
  MeAppTheme {
