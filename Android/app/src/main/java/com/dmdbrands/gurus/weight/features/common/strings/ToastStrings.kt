...
object ToastStrings {
  ...
  object Error {
    ...
    object UpdateProfileError {
      ...
      const val errorUpdatingProfileHeader ="Error saving profile!"
      const val errorUpdatingProfileMessage = "Please try again."
      const val ErrorUpdatingEmail ="Email address is already in use"
