...
object DeviceSourceStrings {
  const val Wifi = "wifi scale"
  const val BluetoothWifi = "btWifiR4"
  const val Bluetooth = "bluetooth scale"
  const val Appsync = "appsync scale"
  const val Lcbt = "lcbt scale"
}
