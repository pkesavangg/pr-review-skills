...
object AppConfig {
    ...
    object Integrations {
        fun fitbit(accountId: String) =
            "https://www.fitbit.com/oauth2/authorize?response_type=code&client_id=23TH5Z&redirect_uri=https%3A%2F%2Fapi.weightgurus.com%2Fv2%2Fauth%2Ffitbit&scope=profile%20weight&state=v3-$accountId"
