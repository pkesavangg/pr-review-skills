...
interface ReorderableCollectionItemScope {
   ...
   *
   * This modifier can only be used on the UI element that is a child of [com.greatergoods.meapp.features.common.components.reorderable.ReorderableItem].
   *
 ...
 *
 * @param state The return value of [rememberReorderableLazyListState], [com.greatergoods.meapp.features.common.components.reorderable.rememberReorderableLazyGridState], or [rememberReorderableLazyStaggeredGridState]
