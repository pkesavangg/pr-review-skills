...
sealed class IntegrationProvider(
  ...
  fun getOAuthUrl(accountId: String): String =
    when (this) {
      is Fitbit -> "https://www.fitbit.com/oauth2/authorize?response_type=code&client_id=22B2QV&redirect_uri=https%3A%2F%2Fapi.weightgurus.com%2Fv2%2Fauth%2Ffitbit&scope=profile%20weight&state=v3-$accountId"
      ...
      is HealthConnect -> "https://api.weightgurus.com/v2/auth/healthconnect?state=v3-$accountId" // Health Connect doesn't use OAuth
    }
