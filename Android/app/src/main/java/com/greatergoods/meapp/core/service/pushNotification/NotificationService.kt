...
class NotificationService
    ...
    constructor(
        ...
        private val statusMap = MutableLiveData<MutableMap<String, Boolean>>(mutableMapOf())
        ...
        fun cancelAll() {
            ...
            statusMap.value?.map { update(it.key, false) }
        }
         ...
         */
        fun subscribeStatus(): Flow<Map<String, Boolean>> = statusMap.asFlow()
