...
class DeviceService
  ...
  constructor(
     ...
     */
    override suspend fun getConnectedScales(): List<Device> = _savedScales.value.filter { it.isConnected }
     ...
     */
    override suspend fun getUnsyncedScales(): List<Device> = _savedScales.value.filter { !it.isSynced }
