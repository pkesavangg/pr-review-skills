...
class LogManager @Inject constructor(
     ...
     */
    fun getRecentLogs(days: Int = 1): Flow<List<LogEntity>> {
        return logRepository.getLogsForLastDays(days)
    }
     ...
     */
    fun getLogsByType(type: ILogRepository.LogType): Flow<List<LogEntity>> {
     ...
     */
    fun getLogsBySession(): Flow<List<LogEntity>> {
        return logRepository.getLogsBySessionId()
    }
