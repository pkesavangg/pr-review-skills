      ...
      viewModelScope.launch {
        deviceService.savedScales.collect { devices ->
          ...
          device?.let { scaleDevice ->
            ...
            handleIntent(ScaleModeIntent.SetMode(scaleDevice.shouldMeasureImpedance, false))
            handleIntent(ScaleModeIntent.SetHeartRate(scaleDevice.shouldMeasurePulse, false))
          }
        }
      }
    }
        ...
        try {
          ...
          val updatedDisplayMetrics =
            updateDisplayMetricsForHeartRate(
              currentMetrics = scale.displayMetrics ?: emptyList(),
