...
import com.greatergoods.meapp.features.entry.helper.EntryHelper.toScaleEntry
...
class EntryViewModel @Inject constructor(
    ...
    private fun saveEntry() {
        ...
        viewModelScope.launch {
            val scaleEntry = _state.value.form.controls.toScaleEntry(_state.value.weightMode)
            try {
