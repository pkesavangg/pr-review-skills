...
data class EntryForm(
  ...
  companion object {
    ...
    fun create(
      ...
      height: Int? = 0,
      scaleEntry: com.greatergoods.meapp.domain.model.storage.entry.ScaleEntry? = null,
    ): EntryForm {
              val generalMetrics =
...
sealed interface EntryIntent : IReducer.Intent {
  ...
  data class LoadAppSyncData(
    val scaleEntry: com.greatergoods.meapp.domain.model.storage.entry.ScaleEntry,
    val height: Int? = null
  ) : EntryIntent
}
