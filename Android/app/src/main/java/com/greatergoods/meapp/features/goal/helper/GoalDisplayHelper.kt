...
object GoalDisplayHelper {
    ...
    fun transformWeight(
        ...
        val weight = if (weightless?.isWeightlessOn == true) {
    ...
    fun computeToGoal(
        ...
        val transformedGoalWeight = transformWeight(
            value = goalWeight,
            showSymbol = false,
        ...
        val transformedLatestWeight = transformWeight(
