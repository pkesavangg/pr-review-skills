...
val SCALES =
  listOf(
    ...
    ScaleInfo("AppSync Bathroom Scale", "0364", ScaleSetupType.AppSync, true),
    ScaleInfo("AppSync Body Fat Scale", "0369", ScaleSetupType.AppSync, true),
    ScaleInfo("AppSync Body Fat Scale", "0370", ScaleSetupType.AppSync, true),
    ScaleInfo("AppSync Bathroom Scale", "0371", ScaleSetupType.AppSync, false),
