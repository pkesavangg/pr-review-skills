...
class AccountService
     ...
     */
    override val loggedInAccountsFlow: Flow<List<Account>> = accountRepository.getLoggedInAccounts().map { it.sortedActiveFirst() }
    ...
    override suspend fun changePassword(
        ...
        return try {
            ...
            val response = accountRepository.updatePassword(activeAccountFlow.first()!!.id, currentPassword, newPassword)
