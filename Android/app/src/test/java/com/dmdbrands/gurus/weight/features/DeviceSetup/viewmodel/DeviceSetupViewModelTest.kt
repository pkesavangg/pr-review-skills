...
/**
 * Unit tests for [DeviceSetupViewmodel] via a concrete test subclass.
 *
...
class DeviceSetupViewModelTest {
    ...
    // Minimal test state/intent for the abstract DeviceSetupViewmodel
    ...
    /** Concrete test subclass of DeviceSetupViewmodel to expose protected members. */
    class TestScaleSetupViewModel(
        ggDeviceService: GGDeviceService,
        connectivityObserver: IConnectivityObserver,
        permissionService: GGPermissionService,
    ) : DeviceSetupViewmodel<TestState, TestIntent>(
        ggDeviceService = ggDeviceService,
    ...
    fun `discoveredScale is null by default`() {
        ...
        val field = DeviceSetupViewmodel::class.java.getDeclaredField("discoveredScale")
