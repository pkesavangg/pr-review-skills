...
class ProfileReducerTest {
    ...
    fun `Submit sets isLoading true and clears error`() {
        ...
        val result = requireNotNull(reducer.reduce(state, ProfileIntent.Submit))
    ...
    fun `LoadProfile sets isLoading true and clears error`() {
        val result = requireNotNull(reducer.reduce(initialState, ProfileIntent.LoadProfile))
    ...
    fun `ProfileLoaded populates form with all fields including gender and height`() {
        ...
        val result = requireNotNull(reducer.reduce(initialState, intent))
    ...
    fun `Error sets error message and clears isLoading`() {
        ...
        val result = requireNotNull(reducer.reduce(state, ProfileIntent.Error("Network failure")))
    ...
    fun `UpdateForm replaces form in state`() {
        ...
        val result = requireNotNull(reducer.reduce(initialState, ProfileIntent.UpdateForm(newForm)))
    ...
    fun `Success clears isLoading and error`() {
        ...
        val result = requireNotNull(reducer.reduce(state, ProfileIntent.Success))
