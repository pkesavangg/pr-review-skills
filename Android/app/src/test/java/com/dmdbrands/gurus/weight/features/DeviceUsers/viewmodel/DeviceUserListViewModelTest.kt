...
class DeviceUserListViewModelTest {
    ...
    private lateinit var viewModel: DeviceUserListViewModel
    ...
    private fun createViewModel(): DeviceUserListViewModel =
        DeviceUserListViewModel(
    ...
    fun `SetScale updates scale in state`() = runTest(mainDispatcherRule.scheduler) {
        ...
        viewModel.handleIntent(DeviceUserListIntent.SetScale(device))
        advanceUntilIdle()
    ...
    fun `SetScale with hasSetUsername updates flag`() = runTest(mainDispatcherRule.scheduler) {
        ...
        val device = TestFixtures.bleDevice
        viewModel.handleIntent(DeviceUserListIntent.SetScale(device, hasSetUsername = true))
        advanceUntilIdle()
    ...
    fun `SetUserList updates user list and clears loading`() = runTest(mainDispatcherRule.scheduler) {
        ...
        viewModel.handleIntent(DeviceUserListIntent.SetUserList(users))
        advanceUntilIdle()
    ...
    fun `Save sets isLoading to true`() = runTest(mainDispatcherRule.scheduler) {
        ...
        viewModel.handleIntent(DeviceUserListIntent.Save)
        advanceUntilIdle()
    ...
    fun `Back with no changes navigates back directly`() = runTest(mainDispatcherRule.scheduler) {
        ...
        viewModel.handleIntent(DeviceUserListIntent.Back)
        advanceUntilIdle()
    ...
    fun `DeleteUser shows confirmation dialog`() = runTest(mainDispatcherRule.scheduler) {
        ...
        viewModel.handleIntent(DeviceUserListIntent.DeleteUser(user))
        advanceUntilIdle()
    ...
    fun `RefreshUserList with no scale shows error toast`() = runTest(mainDispatcherRule.scheduler) {
        ...
        viewModel.handleIntent(DeviceUserListIntent.RefreshUserList)
        advanceUntilIdle()
